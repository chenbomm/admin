...
Route::middleware(['admin_auth','permission_auth'])->prefix('admin')->group(function(){
   ...
   /*#############################[权限相关]#############################*/
    ...
    /*#############################[会员管理]#############################*/
    //列表
    Route::get('menber/list','Admin\MenberController@list')->name('admin.menber.list');
    //详情
    Route::get('menber/detail/{id}','Admin\MenberController@detail')->name('admin.menber.detail');
    /*#############################[会员管理]#############################*/
    /*#############################[地区管理]#############################*/
    //地区列表
