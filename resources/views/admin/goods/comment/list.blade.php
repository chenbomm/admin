            ...
            <div class="table-responsive">
                <table class="table table-primary  mb30">
                    ...
                    <tr>
                        <td>{{$v->id or null}}</td>
                        <td>{{$v->goods_name}}</td>
                        <td>{{$v->username or 'admin'}}</td>
                        <td><img  style="width:60px;" src="{{$v->image_url or '/images/photos/media3.png'}}"></td>
                        <td>商品评论</td>
                        <td>{{$v->content or null}}</td>
                        <td>
                            <a class="btn btn-sm btn-success" href="/admin/goods/comment/del/{{$v->id}}">删除
                            </a>
                        </td>
                    </tr>
                        @endforeach
